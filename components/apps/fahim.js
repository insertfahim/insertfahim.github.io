...
export class AboutFahim extends Component {
    constructor() {
        super();
        this.screens = {};
        this.state = {
...
export default AboutFahim;

export const displayAboutFahim = () => {
    return <AboutFahim />;
};
        ...
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img
                    ...
                    alt="Mohammad Fahim Logo"
                />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>
                    my name is <span className="font-bold">Mohammad Fahim</span>{" "}
                    ,
                </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">
                    ...
                    currently pursuing Computer Science. I've completed my 6
                    month SWE intern at{" "}
                    ...
                    , and now I'm looking for full-time frontend engineer roles!
                    ( Hit me up{" "}
                    <a
                        className="text-underline"
                        href="mailto:faahim06@gmail.com"
                    >
                        <u>@faahim06@gmail.com</u>
                    </a>{" "}
                    :) )
                </li>
                ...
                <li className=" mt-3 list-time">
                    ...
                    time reading books, playing minecraft or watching{" "}
                    <a
    ...
    const project_list = [
        {
            ...
            date: "January 2025",
            link: "https://github.com/insertfahim/insertfahim.github.io",
            description: [
        ...
        {
            name: "Microsoft Teams Fluent Animated emojis",
            date: "Feb 2025",
            link: "https://github.com/insertfahim/Animated-Fluent-Emojis",
            description: [
                "All the Microsoft animated fluent emojis are available in one place and ready to use in your next project or README file.",
            ],
            domains: ["javascript", "typescript", "CSS"],
        },
        {
            name: "Telegram Animated emojis",
            date: "Nov 2024",
            link: "https://github.com/insertfahim/Telegram-Animated-Emojis",
            description: [
                "All the Telegram animated emojis are available in one place and ready to use in your next project or README file. Image format: .webp",
            ],
            domains: ["javascript", "typescript", "CSS"],
        },
        {
            name: "nyx",
            date: "Dec 2024",
            link: "https://github.com/insertfahim/nyx",
            description: [
                        ...
                        <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
                            <div className="flex flex-wrap justify-between items-center">
                                <div className="flex justify-center items-center">
                                    ...
                                    <iframe
                                        src={`https://ghbtns.com/github-btn.html?user=insertfahim&repo=${projectName}&type=star&count=true`}
                                        frameBorder="0"
                                        scrolling="0"
                                        width="150"
                                        height="20"
...
function Resume() {
    return (
        <iframe
            ...
            src="./files/Tasnimul Mohammad Fahim_Resume.pdf"
            title="Mohammad Fahim resume"
            frameBorder="0"
        ></iframe>
    );
}
