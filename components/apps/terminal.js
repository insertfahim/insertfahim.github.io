...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: [
                "insertfahim-personal-portfolio",
                "synonyms-list-react",
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">fahim@Dell</div>
    ...
    checkKey = (e) => {
        if (e.key === "Enter") {
            ...
            let command = $(`input#terminal-input-${terminal_row_id}`)
                .val()
                .trim();
            if (command.length !== 0) {
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result =
                        "Command '" +
                        main +
                        "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-fahim, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-fahim":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-fahim");
                } else {
                    result =
                        "Command '" +
                        main +
